...
import InviteBlog from './blogs/InviteBlog';
...
const BlogHeader = ({ companyDetails, slugListArray, blogListArray, blogContent, urlparse, currentId, likeCount }) => {
    ...
    alert('dataArray here: ' + JSON.stringify(dataArray) + 'index: [ ' + index + ' ]');
    ...
    const toggleNextCompany = (event) => {
        ...
        console.log('Here next '+ companyIndex + ' of ' + (slugsList.slugs.length - 1));

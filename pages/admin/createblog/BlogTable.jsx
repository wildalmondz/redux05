...
export default function BlogTable({ data }) {
    const participation  = data[0] || []; // Ensure participation is defined and initialized as an empty array if undefined
    ...
    const handleNewClick = () => {
        window.location.href = './rtest/blogcreate';
    };

    const handleCellClick = (columnId, cellValue) => {
        if (columnId === 'id') {
            alert('Id: ' + columnId + 'value: ' + cellValue);
        }
    };

...
export default function BlogTable({ groupId }) {
    ...
    const handleNewClick = () => {
        window.location.href = './blogs/blogcreate';
    };

    const handleCellClick = (columnId, cellValue) => {
        if (columnId === 'id') {
            alert('Edit ' + columnId + 'value: ' + cellValue);
        }
        if (columnId === 'status') {
            alert('Disable ' + columnId + 'value: ' + cellValue);
        }
    };
                                                    ...
                                                    >
                                                        {column.id === 'status' ? (
                                                            <Select
                                                                ...
                                                                onChange={(e) => handleCellClick(column.id, e.target.value)}
                                                            >

    ...
    return (
        <section className="terms">
            ...
            <p>
                ...
                <br />
                <br />
                <strong>2) ASSENT & ACCEPTANCE</strong> By using the Website, You warrant that You have
                ...
                <br />
                <br />
                <strong>3) LICENSE TO USE WEBSITE</strong> The Company may provide You with certain
                ...
                <br />
                <br />
                <strong>5) USER OBLIGATIONS</strong> As a user of the Website or Services, You may be asked
                ...
                <br />
                <br />
                <strong>6) ACCEPTABLE USE</strong> You agree not to use the Website or Services for any
                ...
                <br />
                <br />
                <strong>7) AFFILIATE MARKETING & ADVERTISING</strong> The Company, through the Website and
                ...
                <br />
                <br />
                <strong>8) PRIVACY INFORMATION</strong> Through Your Use of the Website and Services, You
                ...
                <br />
                <br />
                <strong>9) REVERSE ENGINEERING & SECURITY</strong> You agree not to undertake any of the
                following actions:
                <br />
                ...
                <br />
                <br />
                <strong>10) DATA LOSS</strong> The Company does not accept responsibility for the security
                ...
                <br />
                <br />
                <strong>13) THIRD-PARTY LINKS & CONTENT</strong> The Company may occasionally post links to
                ...
                <br />
                <br />
                <strong>14) MODIFICATION & VARIATION</strong> The Company may, from time to time and at any
                ...
                <br />
                <br />
                <strong>15) ENTIRE AGREEMENT</strong> This Agreement constitutes the entire understanding
                ...
                <br />
                <br />
                <strong>16) SERVICE INTERRUPTIONS</strong> The Company may need to interrupt Your access to
                ...
                <br />
                <br />
                <strong>17) TERM, TERMINATION & SUSPENSION</strong> The Company may terminate this
                ...
                <br />
                <br />
                <strong>19) LIMITATION ON LIABILITY</strong> The Company is not liable for any damages that
